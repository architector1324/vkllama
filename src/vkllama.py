...
if __name__ == '__main__':
    ...
    run_parser.add_argument('-a', '--address', default='0.0.0.0:11434', type=str, help='Server host address')
    ...
    list_parser.add_argument('-a', '--address', default='0.0.0.0:11434', type=str, help='Server host address')
    ...
    serve_parser.add_argument('-m', '--models', default=vkllama_serve.DEFAULT_MODELS_PATH, type=str, help='LLM models path')
    serve_parser.add_argument('-p', '--port', default=11434, type=int, help='Server port')
