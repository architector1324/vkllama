...
Pre-built `vkllama` binaries are available in the [releases section of this repository](https://github.com/architector1324/vkllama/releases).
...
1.  **Clone the repository**:
    ...
    ```bash
    git clone https://github.com/architector1324/vkllama.git
    cd vkllama
    ```
